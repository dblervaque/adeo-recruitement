...
describe('[Function] mapAndAppendCountInNames', () => {
  it('should return an array with the count of people for each country', () => {
    const result = mapAndAppendCountInNames(data);
